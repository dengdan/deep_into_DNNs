...
class network:
    def __init__(self):
        ...
        def cnn():
            ...
            conv1 = ConvFactory(data = data,  num_filter = 32, kernel = kernel3x3, stride = stride1x1, pad = pad1x1, name = "conv1");
            pool1 = mx.symbol.Pooling(data = conv1, kernel = kernel3x3, stride = stride2x2 , pool_type = MAX, name='pooling1_max');
            conv2 = ConvFactory(data = pool1, num_filter = 2, kernel = kernel3x3, stride = stride1x1, pad = pad1x1, name = 'conv2');
